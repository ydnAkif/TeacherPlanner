...
enum AppError: LocalizedError {
    ...
    var recoverySuggestion: String? {
        ...
        case .dataLoadFailed, .dataSaveFailed, .dataDeleteFailed:
            return "Uygulamayı yeniden başlatmayı deneyin"
        case .validationFailed, .invalidFormat, .requiredFieldMissing:
